...
const ReviewSectionFour = () => {
  ...
  return (
    <section className="review_section section_space_lg bg_light_3">
        ...
        <div className="row justify-content-center">
          <div className="col col-lg-7">
            <div className="review_carousel_3 arrow_right_left">
              <div className="common_carousel_1col row" data-slick='{"dots": false}'>
                <Slider {...settings} ref={sliderRef}>
                  {review_data.length > 0 &&
                    review_data.slice(0, 4).map((item) => (
...
export default ReviewSectionFour;