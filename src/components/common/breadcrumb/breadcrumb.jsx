      ...
      <div className="container decoration_wrap">
        ...
        <div className="deco_item shape_1 wow fadeInUp" data-wow-delay=".1s">
          <Image
            ...
            alt={t('common.breadcrumb.shape_image_alt')}
          />
        </div>
        <div
          ...
          data-wow-delay=".1s"
        >
        <img src="/assets/images/shapes/shape_circle_half_1.svg" data-parallax='{"y" : 200, "smoothness": 10}' alt={t('common.breadcrumb.shape_image_alt')}/>
        </div>
