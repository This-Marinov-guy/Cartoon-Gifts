        ...
        <div className="tab-content" id="nav-tabContent">
          <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabIndex="0">
            <div className="grid row">
              {
                portfolio_data.slice(5,13).map((item) => (
                    ...
                    <div className="portfolio_item layout_grid text-center">
                      <div className="item_image">
                        <Link href={`/portfolio-details/${item.id}`}>
                          <Image src={item.image} alt="Paradox Portfolio Image" />
                        </Link>
                      </div>
            ...
            <div className="grid row">
              {
                portfolio_data.slice(5,14).map((item) => (
                  item.graphics && <div className="col col-lg-6 element-item graphics " data-category="graphics" key={item.id}>
                    <div className="portfolio_item layout_grid text-center">
                      <div className="item_image">
                        <Link href={`/portfolio-details/${item.id}`}>
                          <Image src={item.image} alt="Paradox Portfolio Image" />
          ...
          <div className="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" tabIndex="0">
            <div className="grid row">
              {
                portfolio_data.slice(5,14).map((item) => (
                  item.uiUx && <div className="col col-lg-6 element-item graphics " data-category="graphics" key={item.id}>
                    <div className="portfolio_item layout_grid text-center">
                      <div className="item_image">
                        <Link href={`/portfolio-details/${item.id}`}>
                          <Image src={item.image} alt="Paradox Portfolio Image" />
          ...
          <div className="tab-pane fade" id="nav-wordpress" role="tabpanel" aria-labelledby="nav-wordpress-tab" tabIndex="0">
            <div className="grid row">
              {
                portfolio_data.slice(5,14).map((item) => (
                  item.wordpress && <div className="col col-lg-6 element-item graphics " data-category="graphics" key={item.id}>
                    <div className="portfolio_item layout_grid text-center">
                      <div className="item_image">
                        <Link href={`/portfolio-details/${item.id}`}>
                          <Image src={item.image} alt="Paradox Portfolio Image" />
          ...
          <div className="tab-pane fade" id="nav-webdesign" role="tabpanel" aria-labelledby="nav-webdesign-tab" tabIndex="0">
            <div className="grid row">
              {
                portfolio_data.slice(5,14).map((item) => (
                  item.webDesign && <div className="col col-lg-6 element-item graphics " data-category="graphics" key={item.id}>
                    <div className="portfolio_item layout_grid text-center">
                      <div className="item_image">
                        <Link href={`/portfolio-details/${item.id}`}>
                          <Image src={item.image} alt="Paradox Portfolio Image" />
